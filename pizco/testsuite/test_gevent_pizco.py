...
class AgentTest(unittest.TestCase):
    ...
    def test_agent_rep(self):
        ...
        agent = Agent(manager=GeventAgentManager)
    ...
    def test_agent_stop(self):
        ...
        agent = Agent(manager=GeventAgentManager)
        agent_ctrl = Agent(manager=GeventAgentManager)
    ...
    def test_agent_req_agent_rep(self):
        ...
        agent1 = Add1(manager=GeventAgentManager)
        agent2 = Add1(manager=GeventAgentManager)
    ...
    def test_server(self):
        ...
        s = Server(Example(), manager=GeventAgentManager)

        proxy = Proxy(s.rep_endpoint, manager=GeventAgentManager)
    ...
    def test_server_no_inspect(self):
        ...
        s = NoInspectServer(Example(), manager=GeventAgentManager)
    ...
    def test_server_return_dict(self):
        ...
        s = ReturnDictsServer(Example(), manager=GeventAgentManager)
    ...
    def test_agent_subscribe_default(self):
        ...
        agent = DefNot(manager=GeventAgentManager)
    ...
    def test_signal_auto(self):
        ...
        s = Server(ExampleAuto(), rep_endpoint=address, manager=GeventAgentManager)

        proxy = Proxy(address, manager=GeventAgentManager)
    ...
    def test_signal(self):
        ...
        s = Server(Example(), rep_endpoint=address, manager=GeventAgentManager)
    ...
    def test_signal_two_proxies(self):
        ...
        proxy1 = Proxy(address, manager=GeventAgentManager)
        proxy2 = Proxy(address, manager=GeventAgentManager)
    ...
    def test_wildcards(self):
        ...
        server = Server(serverto, rep_endpoint=endpoint, manager=GeventAgentManager)
        serverto.add_events()
        to = AggressiveClientObject()
        i = Proxy(endpoint1, manager=GeventAgentManager)
        ...
        i2 = Proxy(endpoint2, manager=GeventAgentManager)
        i2._proxy_ping()
